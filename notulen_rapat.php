    ...
    try {
        if ($stmt_update->execute()) {
            ...
            if (file_exists('generate_pdf.php')) {
                ...
                if ($pdf_path) {
                    $_SESSION['temp_success_msg'] = "Notulen berhasil difinalisasi! PDF telah dibuat.";
                } else {
            ...
            if (strpos($stmt_update->error, 'Data truncated') !== false) {
                $_SESSION['temp_error_msg'] = "Error: Nilai status 'final' tidak didukung. Periksa struktur tabel notulen.";
            } else {
