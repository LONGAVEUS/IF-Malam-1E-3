...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['simpan_notulen'])) {
        ...
        // Simpan ke database
        $sql = "INSERT INTO notulen (judul, tanggal, isi, penanggung_jawab, status, lampiran) VALUES (?, ?, ?, ?, ?, ?)";
...
$sql_notulens = "SELECT id, judul, tanggal, isi, penanggung_jawab, status, lampiran FROM notulen ORDER BY tanggal DESC, id DESC LIMIT 5";
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="stats-grid">
      <div class="stat-card">
        ...
        <div class="stat-info">
          <div class="stat-number"><?php echo $total_notulen; ?></div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-info">
          <div class="stat-number"><?php echo $notulen_hari_ini; ?></div>
          <div class="stat-label">Notulen Hari Ini</div>
        </div>
      </div>
      <div class="stat-card">
        <div class="stat-icon">
        ...
        <div class="stat-info">
          <div class="stat-number"><?php echo $notulen_bulan_ini; ?></div>
          <div class="stat-label">Notulen Bulan Ini</div>
        </div>
      </div>
    </div>
            ...
            <div class="notulen-item" data-id="<?php echo $notulen['id']; ?>">
              <div class="notulen-main">
                ...
                <div class="notulen-meta">
                  ...
                  <span class="notulen-penanggung-jawab"><i class="fas fa-user"></i> <?php echo htmlspecialchars($notulen['penanggung_jawab']); ?></span>
                  ...
                  <?php if (!empty($notulen['lampiran'])): ?>
                    <span class="notulen-lampiran">
                      ...
                      <a href="view.php?file=<?php echo urlencode($notulen['lampiran']); ?>" target="_blank" title="<?php echo htmlspecialchars($nama_file_asli); ?>">
                        Lampiran
                      </a>
                    </span>
                  <?php endif; ?>
              ...
              <div class="notulen-actions">
                ...
                <a href="notulis.php?hapus=<?php echo $notulen['id']; ?>" class="action-btn delete" title="Hapus Notulen" onclick="return confirm('Apakah Anda yakin ingin menghapus notulen ini?')">
                ...
                <?php if (!empty($notulen['lampiran'])): ?>
                  <a href="view.php?file=<?php echo urlencode($notulen['lampiran']); ?>" class="action-btn download" target="_blank" title="Lihat Lampiran">
      ...
      <div class="modal-body">
        <form id="notulenForm" method="POST" action="notulis.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea id="isiNotulen" name="isi" rows="6" placeholder="Tulis isi notulen rapat di sini..." required></textarea>
          </div>
          <div class="form-group">
