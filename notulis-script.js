    ...
    fetch(`get_notulen_detail.php?id=${id}`)
      ...
      .then((data) => {
        ...
        if (userStatusKehadiran) {
          ...
          const waktu = userWaktuKonfirmasi ? ` pada ${new Date(userWaktuKonfirmasi).toLocaleString("id-ID")}` : "";
            ...
            <div class="section-card">
              ...
              <div class="signature-wrapper" style="text-align:center; padding:15px;">
                ...
                <div class="modal-actions" style="justify-content:center; margin-top:15px; gap:10px;">
                  ...
                  <button type="button" class="confirm-btn hadir" onclick="prosesSimpanTtd(${notulen.id})">Simpan & Hadir </button>
          ...
          pesertaSection = `
            <div class="section-card">
              ...
              <div class="access-restricted">
                ...
                <p>${
                  isCreator
                    ? "Akses ke daftar peserta tersedia untuk pembuat notulen."
                    : "Akses ke daftar peserta dibatasi hanya untuk peserta yang hadir."
                }</p>
              </div>
            </div>
          `;
          ...
          pembahasanSection = `
            <div class="section-card">
              ...
              <div class="content-text">
                ${
                  notulen.pembahasan
                    ? escapeHtml(notulen.pembahasan).replace(/\n/g, "<br>")
          ...
          pembahasanSection = `
            <div class="section-card">
              ...
              <div class="access-restricted">
                ...
                <p>${
                  isCreator
                    ? "Konten pembahasan dapat diakses oleh pembuat notulen."
                    : "Konten pembahasan hanya dapat diakses oleh peserta yang hadir."
                }</p>
              </div>
            </div>
          `;
          ...
          hasilAkhirSection = `
            <div class="section-card">
              ...
              <div class="content-text">
                ${
                  notulen.hasil_akhir
                    ? escapeHtml(notulen.hasil_akhir).replace(/\n/g, "<br>")
          ...
          hasilAkhirSection = `
            <div class="section-card">
              ...
              <div class="access-restricted">
                ...
                <p>${
                  isCreator
                    ? "Hasil akhir rapat dapat diakses oleh pembuat notulen."
                    : "Hasil akhir rapat hanya dapat diakses oleh peserta yang hadir."
                }</p>
              </div>
            </div>
          `;
          ...
          lampiranSection = `
            <div class="section-card">
              ...
              <div class="access-restricted">
                <i class="fas fa-lock"></i>
                <p>${
                  isCreator ? "Lampiran dapat diakses oleh pembuat notulen." : "Lampiran hanya dapat diakses oleh peserta yang hadir."
                }</p>
              </div>
            </div>
          `;
